...
EXP_HYPER_LIST = {'Data': {'dataset': None, 'data_aug': None, 'seq_filter_len': None,
                  ...
                  'Training': {'epoch_num': None, 'train_batch': None,
                               ...
                               'device': None, 'num_worker': None, 'seed': None, 'SR_task': None, 'session_len': None},
...
def get_default_config():
    ...
    parser.add_argument('--SR_task', default='Next-Item', type=str, choices=['Next-Item', 'Next-Session'])
    parser.add_argument('--session_len', default=3, type=int, help='next session length')
    parser.add_argument('--seed', default=-1, type=int, help="random seed, only -1 means don't set random seed")
